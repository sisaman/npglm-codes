...
Replacing the above series in the likelihood and taking the logarithm, we end up with the following log-likelihood function{\color{red}, denoted by $\log\mathcal{L}$}:
